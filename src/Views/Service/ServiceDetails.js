            ...
            <section className="service-details-wrap section-padding-md-equal bg-color-accent2">
                <div className="container">
                    <div className="row mb--60 d-flex align-items-center">
                        <div className="col-lg-6 has-animation pr-5 active-animation">
                    ...
                    <div className="row box-bottom-margin has-animation active-animation">
                    ...
                    <div className="row d-flex align-items-center has-animation active-animation">
                        <div className="col-lg-6 has-animation order-lg-2 active-animation">
                            <div className="service-details-box">
                                <div className="content-holder">
                                    <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-100">
                        ...
                        <div className="col-lg-6 has-animation order-lg-1 active-animation">
                            <div className="service-details-box">
                                <div className="item-figure">
